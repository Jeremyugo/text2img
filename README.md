...
This repository is part of the workshop covered under the [Applied Data Science Lab (ADSL)](https://www.cybera.ca/adsl/) program and the original contributors to this project are:
- [Vadim Avkhimenia](https://github.com/avkhimen)
- [Vishal Subramanian Balashankar](https://github.com/vishalbalashankar)
...
4. Kill processes using NVIDIA drivers with:
-  find processes and their PIDs using NVIDIA drivers
```shell
...
sudo kill -9 <PID>
```
- kill persistence daemon:
```shell
sudo service nvidia-persistenced stop
```

5. Install the driver and CUDA with: 
